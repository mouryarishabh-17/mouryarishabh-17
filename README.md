...
<div align="center">
  ...
  <a href="mailto:rishabhmourya018@gmail.com">
    <img src="https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white" alt="rishabhmourya018@gmail.com"/>
  </a>
</div>
...
|---------|-------------|------------|
| **🤖 AnalytixAI**<br/>*(Final Year Project)* | Automated Analytics & GenAI Insight System that transforms raw data into intelligent business narratives. Real-time analysis powered by LLMs. | `Python` `FastAPI` `GenAI` `LLMs` `Pandas` |
| **📊 Market Data Pipeline** | Scalable ETL pipeline engineering: CSV ingestion → Kafka streaming → Spark processing → Cloud DB storage. Production-grade data infrastructure. | `Apache Kafka` `Apache Spark` `AWS` `Python` `PostgreSQL` |
